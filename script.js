...
var addstg7 = () => {
    ...
    form.insertAdjacentHTML("beforeend", '<div class="inform"><table><tr><td><label for="I">УИ двигателя</label></td><td><input type="number" name="I"></td></tr><tr><td><label for="M">Дополнительная масса ступени</label></td><td><input type="number" name="M"></td></tr><tr><td><label for="V">Дельта скорости</label></td><td><input type="number" name="V"></td></tr></table></div>')
}
